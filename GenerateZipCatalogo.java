...
import com.example.ejercicio05.MySqlDBConexion;
...
public class GenerateZipCatalogo {
    ...
    public void procesar() {
        ...
        try {
            fileWriter = new FileWriter("D:/catalogos/catalogos.json");
        ...
        try {
            fileWriterXML = new FileWriter("D:/catalogos/catalogos.xml");
       ...
       String[] files = { "D:/catalogos/catalogos.json", "D:/catalogos/catalogos.xml" };

       try {
            ZipOutputStream zipOut = new ZipOutputStream(new FileOutputStream("D:/catalogos/catalogosComprimido.zip"));
